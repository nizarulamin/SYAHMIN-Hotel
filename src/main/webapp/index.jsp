<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
        <section id="nav">
            <nav class="navbar navbar-light navbar-expand-xxl navigation-clean-button" id="navbar_top"
                ...
                <div class="container site-mobile-menu"><img src="assets/img/slogo-removebg-preview.png"
                        style="width: 46px;margin-right: 12px;"><a class="navbar-brand" href="index.jsp"
                ...
                <div class="container hero">
                    <div class="row">
                        <div class="col" style="padding: 127px;">
                            <h1 id="langkawi"
                                style="text-align: center;margin: 177px 0px 24px;filter: brightness(126%);font-size: 92px;text-shadow: 2px 2px #606060;">
                                LANGKAWI</h1>
                            <h1 class="text-center"
                                ...
                                id="syahmin">SYAHMIN Hotel</h1>
                            <h1 id="quote" style="font-size: 15px;text-align: center;margin: 102px 0px 24px;">A
        ...
        <h2 class="text-center" id="hotel-overview"
            style="padding: 16px 0px 0px;padding-top: 91px;padding-bottom: 0px;height: 153px;color: var(--bs-dark);font-weight: bold;">
            Hotel Overview</h2>
                ...
                <div class="container">
                    <div class="intro" style="padding-top: 0px;">
                        <h2 class="text-center"
                            style="padding-top: 40px;padding-bottom: 0px;height: 44px;color: var(--bs-dark);">
                            Accommodation</h2>
                        <p class="text-center" style="padding-bottom: 0px;padding-top: 0px;">Our hotel would make you
                            stay here forever!</p>
                    </div>
                    <div class="row justify-content-center features">
                        ...
                        <div class="col-sm-6 col-md-5 col-lg-4 item">
                            <div class="box" style="height: 253px;"><i class="material-icons icon">local_cafe</i>
                                ...
                                <p class="description">Our own cafe offer you affordable and finger licking good
                                    experience.</p>
                            </div>
                        </div>
                    </div>
